...
func (msg MsgSend) GetMsgs() (msgs []sdk.Msg) {
...
func NewMsgTransaction(from sdk.AccAddress, quantity float32, price float32, txType sdk.TransactionType) *MsgTransaction {
	return &MsgTransaction{from.String(), quantity, price, txType}
}

// Route Implements Msg.
func (msg MsgTransaction) Route() string { return RouterKey }

// Type Implements Msg.
func (msg MsgTransaction) Type() string { return TypeMsgSend }

// ValidateBasic Implements Msg.
func (msg MsgTransaction) ValidateBasic() (err error) {
	if _, err = sdk.AccAddressFromBech32(msg.FromAddress); err != nil {
		return sdkerrors.ErrInvalidAddress.Wrapf("invalid from address: %s", err)
	}
	if msg.Quantity < 0.00000001 {
		return sdkerrors.ErrInvalidQuantity.Wrap("quantity should be > 0.00000001")
	}
	if msg.Price < 0.00000001 {
		return sdkerrors.ErrInvalidPrice.Wrap("price should be > 0.00000001")
	}

	return nil
}
func (msg MsgTransaction) GetMsgs() (msgs []sdk.Msg) {
	msgs = append(msgs, &msg)
	return
}

// GetSignBytes Implements Msg.
func (msg MsgTransaction) GetSignBytes() []byte {
	return sdk.MustSortJSON(ModuleCdc.MustMarshalJSON(&msg))
}

// GetSigners Implements Msg.
func (msg MsgTransaction) GetSigners() []sdk.AccAddress {
	fromAddress, _ := sdk.AccAddressFromBech32(msg.FromAddress)
	return []sdk.AccAddress{fromAddress}
}
func (msg MsgTransaction) GetTxType() sdk.TransactionType { return msg.TxType }

func (msg MsgTransaction) GetPrice() float32    { return msg.Price }
func (msg MsgTransaction) GetQuantity() float32 { return msg.Quantity }
func (msg MsgTransaction) SetQuantity(q float32) {
	msg.Quantity = q
}
func (msg MsgTransaction) GetFrom() string {
