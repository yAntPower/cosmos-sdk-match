...
func DefaultBaseappOptions(appOpts types.AppOptions) []func(*baseapp.BaseApp) {
	...
	return []func(*baseapp.BaseApp){
		...
		baseapp.SetMempool(mempool.NewSellMempool(), sdk.SELL),
		baseapp.SetMempool(mempool.NewBuyMempool(), sdk.BUY),
		baseapp.SetMempool(mempool.NewNoOpMempool(), sdk.MATCH),
		baseapp.SetMempool(mempool.NewSenderNonceMempool(mempool.SenderNonceMaxTxOpt(cast.ToInt(appOpts.Get(FlagMempoolMaxTxs)))), sdk.NORMAL),
	}
}
